...
*COLUMN calibration
parameter oilintinput(r);
loop(r,
oilintinput(r)=0;
);
loop(r,
loop(i$((ord(i)>=1) and (ord(i)<=30)),
oilintinput(r)=oilintinput(r)+sam3(r,"33",i);
);
if(oilintinput(r)=0,
oilintinput(r)=9999;
);
...
loop(r,
loop(i$((ord(i)>=1) and (ord(i)<=30)),
sam3(r,"60",i)$(oilintinput(r)>0)=(sam3(r,"60","60")+sam3(r,"70","60")+sam3(r,"71","60")+sam3(r,"73","60")-sam3(r,"60","63")-sam3(r,"60","65")-sam3(r,"60","70")-sam3(r,"60","71")-sam3(r,"60","72")-sam3(r,"60","73"))*sam3(r,"33",i)/oilintinput(r);
sam3(r,"33",i)$(oilintinput(r)>0)=(sam3(r,"3","33")+sam3(r,"70","33")+sam3(r,"71","33")+sam3(r,"73","33")-sam3(r,"33","63")-sam3(r,"33","65")-sam3(r,"33","70")-sam3(r,"33","71")-sam3(r,"33","72")-sam3(r,"33","73"))*sam3(r,"33",i)/oilintinput(r);
);
);
