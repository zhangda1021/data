...
parameter sam2(r,i,j)

*raw data
set     ri   oldsam rows indices   /1*96/;
set     rj   oldsam columns indices /1*96/;
alias (rj,nj);
...
set     negval15(r,ni,nj)     Flag for negative elements;
set     empty15(r,ni,*)      Flag for empty rows and columns;
parameter       chksam15(r,ni,*)       Consistency check of social accounts;
...
loop(r,
negval15(r,ni,nj) = yes$(sam15(r,ni,nj) < 0);

empty15(r,ni,"row") = 1$(sum(nj, sam15(r,ni,nj)) = 0);
empty15(r,nj,"col") = 1$(sum(ni, sam15(r,ni,nj)) = 0);

chksam15(r,ni,"before") = sum(nj, sam15(r,ni,nj)-sam15(r,nj,ni));
chksam15(r,ni,"scale") = sum(nj, sam15(r,nj,ni));
chksam15(r,ni,"%dev")$sum(nj, sam15(r,ni,nj)) = 100 * sum(nj, sam15(r,ni,nj)-sam15(r,nj,ni)) / sum(nj, sam15(r,ni,nj));
